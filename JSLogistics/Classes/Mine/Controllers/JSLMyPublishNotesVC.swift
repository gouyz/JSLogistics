...
private let myPublishNotesCell = "myPublishNotesCell"

class JSLMyPublishNotesVC: GYZBaseVC {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collView.register(JSLHomeShopCell.classForCoder(), forCellWithReuseIdentifier: myPublishNotesCell)
    ...
    func requestNotesList(){
        ...
        var method: String = "user/MyPublishList"
        if type == "1" {
            method = "user/MyCollectList"
        }
        
        GYZNetWork.requestNetwork(method,parameters: ["page":currPage,"user_id":userDefaults.string(forKey: "userId") ?? ""],  success: { (response) in
...
extension JSLMyPublishNotesVC: UICollectionViewDataSource,UICollectionViewDelegate,CHTCollectionViewDelegateWaterfallLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: myPublishNotesCell, for: indexPath) as! JSLHomeShopCell
...
extension JSLMyPublishNotesVC: JXPagingViewListViewDelegate {
