...
private let fenSiListCell = "fenSiListCell"

class JSLMyFenSiVC: GYZBaseVC {
    ...
    lazy var tableView : UITableView = {
        ...
        table.register(JSLMyFensiCell.classForCoder(), forCellReuseIdentifier: fenSiListCell)
    ...
    func requestFenSiList(){
        ...
        GYZNetWork.requestNetwork("user/MyEctList",parameters: ["page":currPage,"user_id":userDefaults.string(forKey: "userId") ?? ""],  success: { (response) in
            ...
            if response["status"].intValue == kQuestSuccessTag{//请求成功
                ...
                if weakSelf?.dataList.count > 0{
                    ...
                    weakSelf?.showEmptyView(content: "暂无粉丝信息，请点击重新加载", reload: {
                        weakSelf?.hiddenEmptyView()
                        weakSelf?.refresh()
                    })
                }
...
extension JSLMyFenSiVC: UITableViewDelegate,UITableViewDataSource{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: fenSiListCell) as! JSLMyFensiCell
