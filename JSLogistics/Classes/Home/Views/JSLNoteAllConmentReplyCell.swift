//
//  JSLNoteAllConmentReplyCell.swift
//  JSLogistics
//  全部评论 回复cell
...
class JSLNoteAllConmentReplyCell: UITableViewCell {
    
    /// 填充数据
    var dataModel : JSLConmentReplyModel?{
        didSet{
            if let model = dataModel {
                
                userImgView.kf.setImage(with: URL.init(string: model.head_pic!))
                
                nameLab.text = model.nickname
                contentLab.text = "回复\(model.rely_nickname!)：" + model.content!
